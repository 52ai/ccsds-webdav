...
class Ui_ccsds_dialog(object):
    def setupUi(self, ccsds_dialog):
        ...
        self.local_listView = QtGui.QListView(self.bl_frame)
        self.local_listView.setGeometry(QtCore.QRect(0, 50, 461, 241))
        self.local_listView.setObjectName(_fromUtf8("local_listView"))
        ...
        self.remote_listView = QtGui.QListView(self.br_frame)
        self.remote_listView.setGeometry(QtCore.QRect(0, 50, 461, 241))
        self.remote_listView.setObjectName(_fromUtf8("remote_listView"))
        ...
        ccsds_dialog.setTabOrder(self.qc_btn, self.log_listView)
